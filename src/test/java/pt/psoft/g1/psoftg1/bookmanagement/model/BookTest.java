...
class BookTest {
    ...
    void ensureIsbnNotNull(){
        ...
        assertThrows(IllegalArgumentException.class, () -> new Book("id-1",null, validTitle, null, validGenre, authors, null));
    }

    @Test
    void ensureTitleNotNull(){
        authors.add(validAuthor1);
        assertThrows(IllegalArgumentException.class, () -> new Book("id-1",validIsbn, null, null, validGenre, authors, null));
    }

    @Test
    void ensureGenreNotNull(){
        authors.add(validAuthor1);
        assertThrows(IllegalArgumentException.class, () -> new Book("id-1", validIsbn, validTitle, null,null, authors, null));
    }

    @Test
    void ensureAuthorsNotNull(){
        authors.add(validAuthor1);
        assertThrows(IllegalArgumentException.class, () -> new Book("id-1", validIsbn, validTitle, null, validGenre, null, null));
    }

    @Test
    void ensureAuthorsNotEmpty(){
        assertThrows(IllegalArgumentException.class, () -> new Book("id-1", validIsbn, validTitle, null, validGenre, authors, null));
    }
    ...
    void ensureBookCreatedWithMultipleAuthors() {
        ...
        assertDoesNotThrow(() -> new Book("id-1", validIsbn, validTitle, null, validGenre, authors, null));
    }
